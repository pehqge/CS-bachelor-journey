...
#### Como testar
- No canto inferior direito, identifique o botão intitulado "Add Test Objects"
- Pressione-o. Serão adicionados múltiplos objetos de tipos diferentes
- Agora você pode testar o funcionamento do SGI. Para isso, experimente as funcionalidades da interface como bem entender