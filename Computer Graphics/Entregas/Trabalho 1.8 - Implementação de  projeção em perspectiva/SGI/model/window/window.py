...
class Window:
    ...
    def apply_pan(self, d_horizontal: float, d_vertical: float, d_depth: float) -> None:
        ...
        ***
        ...
        - Finalidade: Modificar o método de pan para que o movimento horizontal, vertical e de profundidade seja relativo à orientação atual da câmera. Ao mover em profundidade (frente/trás), o ponto de foco permanece fixo em relação a esse movimento, permitindo que a câmera "entre" ou se afaste dos objetos. Para movimentos laterais/verticais, o foco acompanha a câmera.
        - Prompt empregado: agora arrume o panning para que ele seja feito baseado na visao atual da window, ou seja, se eu clico para esquerda, ele move a window para esquerda em relação ao que estou vendo agora. E também se eu clico em forward, ele deve andar para frente em relação de onde estou, assim conseguindo entrar dentro de objetos.
        ***
