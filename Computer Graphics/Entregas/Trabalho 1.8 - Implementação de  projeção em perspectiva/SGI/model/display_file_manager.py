...
class DisplayFileManager:
    ...
    def update_projections(
        ...
        ***
        ...
        - Finalidade: Modificar o método para aceitar VRP e COP como parâmetros separados e passá-los corretamente para as funções de projeção perspectiva e paralela.
        - Prompt empregado: mude o update_projection em @display_file_manager.py para que ele mande os argumentos certos para a de perspectiva e caso ele não tenha os dados necessarios dentro dele, olhe @window.py e ache um jeito de passar a informação necessária para dentro de update_projection
        ***
        ...
        projection_mtx = TransformationGenerator.get_perspective_projection_matrix(
